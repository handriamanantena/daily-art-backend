...
docker stop dailyart-container-blue || true; docker rm dailyart-container-blue || true; docker run --name dailyart-container-blue -d -p $GREEN_PORT:3000 registry.digitalocean.com/dailyirasuto-backend-images/dailyart:production
